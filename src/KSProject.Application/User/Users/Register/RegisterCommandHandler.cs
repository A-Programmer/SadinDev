...
public sealed class RegisterCommandHandler : ICommandHandler<RegisterCommand, RegisterResponse>
{
    ...
    public async Task<RegisterResponse> Handle(RegisterCommand request, CancellationToken cancellationToken)
    {
        ...
        Domain.Aggregates.Users.User user = Domain.Aggregates.Users.User.Register(Guid.NewGuid(), request.Payload.UserName, hashedPassword,
            request.Payload.Email, request.Payload.PhoneNumber, active: true);
