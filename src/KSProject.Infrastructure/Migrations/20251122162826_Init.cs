    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("1fd5d547-737a-45d3-b71f-c5e8f692d434"), new DateTime(2025, 11, 12, 10, 0, 0, 0, DateTimeKind.Utc), "System", null, "Standard user role with limited permissions.", false, new DateTime(2025, 11, 12, 10, 0, 0, 0, DateTimeKind.Utc), "System", "User", 1L },
                    { new Guid("3fd5d547-737a-45d3-b71f-c5e8f692d434"), new DateTime(2025, 11, 12, 10, 0, 0, 0, DateTimeKind.Utc), "System", null, "Test Role to test soft delete", false, new DateTime(2025, 11, 12, 10, 0, 0, 0, DateTimeKind.Utc), "System", "TestRole", 1L },
                    { new Guid("98f4f7df-15bb-4547-8495-f098a753536f"), new DateTime(2025, 11, 12, 10, 0, 0, 0, DateTimeKind.Utc), "System", null, "Administrator role with all permissions.", false, new DateTime(2025, 11, 12, 10, 0, 0, 0, DateTimeKind.Utc), "System", "Admin", 1L }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("0f44e981-5eac-4625-b420-dd550d4ca78a"), new DateTime(2025, 11, 12, 10, 0, 0, 0, DateTimeKind.Utc), "System", null, false, "Get_All_Roles", new DateTime(2025, 11, 12, 10, 0, 0, 0, DateTimeKind.Utc), "System", 1m, null, "Roles", "Default", 1L },
                    { new Guid("17f9e83c-b763-4e38-8902-1d0583adab05"), new DateTime(2025, 11, 12, 10, 0, 0, 0, DateTimeKind.Utc), "System", null, false, "Get_All_Roles", new DateTime(2025, 11, 12, 10, 0, 0, 0, DateTimeKind.Utc), "System", 0.5m, null, "Roles", "Premium", 1L },
                    ...
                    { new Guid("a8b27fb5-19ef-4179-87fc-fbe75692a93e"), new DateTime(2025, 11, 12, 10, 0, 0, 0, DateTimeKind.Utc), "System", null, false, "Get_Role_By_Id", new DateTime(2025, 11, 12, 10, 0, 0, 0, DateTimeKind.Utc), "System", 5m, "{\"minQuantity\":50,\"discountPercent\":10}", "Roles", "Premium", 1L },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("2fd5d547-737a-45d3-b71f-c5e8f692d434"), true, new DateTime(2025, 11, 12, 10, 0, 0, 0, DateTimeKind.Utc), "System", null, "test@user.com", "vFhI8ifMFh619o3+mMsTEQqchDzmnpU6iBB9hlWD05c=", false, new DateTime(2025, 11, 12, 10, 0, 0, 0, DateTimeKind.Utc), "System", "09123456783", false, "test", null, 1L, null },
                    { new Guid("551de0bd-f8bf-4fa4-9523-f19b7c6dd95b"), true, new DateTime(2025, 11, 12, 10, 0, 0, 0, DateTimeKind.Utc), "System", null, "superadmin@superadmin.com", "01cVBRfT5lroSYX3twWtmf3Dg3KiLs6gzsr4qvggokk=", false, new DateTime(2025, 11, 12, 10, 0, 0, 0, DateTimeKind.Utc), "System", "09123456780", true, "superadmin", null, 1L, null },
                    { new Guid("5d2b2a64-0fa7-46af-bf1c-aadf1d7fb120"), true, new DateTime(2025, 11, 12, 10, 0, 0, 0, DateTimeKind.Utc), "System", null, "admin@admin.com", "PrP+ZrMeO00Q+nC1ytSccRIpSvauTkdqHEBRVdRaoSE=", false, new DateTime(2025, 11, 12, 10, 0, 0, 0, DateTimeKind.Utc), "System", "09123456789", false, "admin", null, 1L, null },
                    { new Guid("9650f7f3-333b-4a77-b992-9a55179bfa12"), true, new DateTime(2025, 11, 12, 10, 0, 0, 0, DateTimeKind.Utc), "System", null, "user2@user.com", "vFhI8ifMFh619o3+mMsTEQqchDzmnpU6iBB9hlWD05c=", false, new DateTime(2025, 11, 12, 10, 0, 0, 0, DateTimeKind.Utc), "System", "09123456787", false, "user2", null, 1L, null },
                    { new Guid("c75e1cf0-84c0-4f9e-a608-e9a9b0e7d62f"), true, new DateTime(2025, 11, 12, 10, 0, 0, 0, DateTimeKind.Utc), "System", null, "user1@user.com", "vFhI8ifMFh619o3+mMsTEQqchDzmnpU6iBB9hlWD05c=", false, new DateTime(2025, 11, 12, 10, 0, 0, 0, DateTimeKind.Utc), "System", "09123456782", false, "user1", null, 1L, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("0acc9f75-9201-4ea5-9a16-5be1c30d6f60"), 50.0m, new DateTime(2025, 11, 12, 10, 0, 0, 0, DateTimeKind.Utc), "System", null, false, new DateTime(2025, 11, 12, 10, 0, 0, 0, DateTimeKind.Utc), "System", new Guid("5d2b2a64-0fa7-46af-bf1c-aadf1d7fb120"), 1L },
                    { new Guid("17f9e83c-b763-4e38-8902-1d0583adab05"), 0.0m, new DateTime(2025, 11, 12, 10, 0, 0, 0, DateTimeKind.Utc), "System", null, false, new DateTime(2025, 11, 12, 10, 0, 0, 0, DateTimeKind.Utc), "System", new Guid("9650f7f3-333b-4a77-b992-9a55179bfa12"), 1L },
                    { new Guid("2a5018f6-c8db-490a-9707-221469d20bb7"), 10.0m, new DateTime(2025, 11, 12, 10, 0, 0, 0, DateTimeKind.Utc), "System", null, false, new DateTime(2025, 11, 12, 10, 0, 0, 0, DateTimeKind.Utc), "System", new Guid("2fd5d547-737a-45d3-b71f-c5e8f692d434"), 1L },
                    { new Guid("c55fb374-3d74-4aa3-b576-d144c49cd184"), 100.0m, new DateTime(2025, 11, 12, 10, 0, 0, 0, DateTimeKind.Utc), "System", null, false, new DateTime(2025, 11, 12, 10, 0, 0, 0, DateTimeKind.Utc), "System", new Guid("551de0bd-f8bf-4fa4-9523-f19b7c6dd95b"), 1L },
                    { new Guid("ed12b679-8fd0-4a0c-ade5-fa6aaccf42fd"), 20.0m, new DateTime(2025, 11, 12, 10, 0, 0, 0, DateTimeKind.Utc), "System", null, false, new DateTime(2025, 11, 12, 10, 0, 0, 0, DateTimeKind.Utc), "System", new Guid("c75e1cf0-84c0-4f9e-a608-e9a9b0e7d62f"), 1L }
                });

            migrationBuilder.InsertData(
                table: "ApiKeys",
                columns: new[] { "Id", "CreatedAt", "CreatedBy", "DeletedOnUtc", "Domain", "ExpirationDate", "IsActive", "IsDeleted", "IsInternal", "Key", "ModifiedAt", "ModifiedBy", "Scopes", "UserId", "Variant", "Version" },
                values: new object[,]
                {
                    { new Guid("0acc9f75-9201-4ea5-9a16-5be1c30d6f60"), new DateTime(2025, 11, 12, 10, 0, 0, 0, DateTimeKind.Utc), "System", null, "localhost", new DateTime(2026, 11, 12, 10, 0, 0, 0, DateTimeKind.Utc), true, false, true, "0acc9f7592014ea59a165be1c30d6f60", new DateTime(2025, 11, 12, 10, 0, 0, 0, DateTimeKind.Utc), "System", "sliders.create,sliders.show-all,sliders.update,users.show-all,users.create,users.update,users.delete", new Guid("5d2b2a64-0fa7-46af-bf1c-aadf1d7fb120"), "Default", 1L },
                    { new Guid("17f9e83c-b763-4e38-8902-1d0583adab05"), new DateTime(2025, 11, 12, 10, 0, 0, 0, DateTimeKind.Utc), "System", null, "localhost", new DateTime(2026, 11, 12, 10, 0, 0, 0, DateTimeKind.Utc), true, false, false, "17f9e83cb7634e3889021d0583adab05", new DateTime(2025, 11, 12, 10, 0, 0, 0, DateTimeKind.Utc), "System", "sliders.create,sliders.show-all", new Guid("c75e1cf0-84c0-4f9e-a608-e9a9b0e7d62f"), "Premium", 1L },
                    { new Guid("2a5018f6-c8db-490a-9707-221469d20bb7"), new DateTime(2025, 11, 12, 10, 0, 0, 0, DateTimeKind.Utc), "System", null, "localhost", new DateTime(2026, 11, 12, 10, 0, 0, 0, DateTimeKind.Utc), true, false, false, "2a5018f6c8db490a9707221469d20bb7", new DateTime(2025, 11, 12, 10, 0, 0, 0, DateTimeKind.Utc), "System", "sliders.create,sliders.show-all", new Guid("2fd5d547-737a-45d3-b71f-c5e8f692d434"), "Default", 1L },
                    { new Guid("c55fb374-3d74-4aa3-b576-d144c49cd184"), new DateTime(2025, 11, 12, 10, 0, 0, 0, DateTimeKind.Utc), "System", null, "localhost", new DateTime(2026, 11, 12, 10, 0, 0, 0, DateTimeKind.Utc), true, false, false, "c55fb3743d744aa3b576d144c49cd184", new DateTime(2025, 11, 12, 10, 0, 0, 0, DateTimeKind.Utc), "System", "sliders.create,sliders.show-all,sliders.update,users.show-all,users.create,users.update,users.delete", new Guid("551de0bd-f8bf-4fa4-9523-f19b7c6dd95b"), "Default", 1L },
                    { new Guid("ed12b679-8fd0-4a0c-ade5-fa6aaccf42fd"), new DateTime(2025, 11, 12, 10, 0, 0, 0, DateTimeKind.Utc), "System", null, "localhost", new DateTime(2026, 11, 12, 10, 0, 0, 0, DateTimeKind.Utc), true, false, false, "ed12b6798fd04a0cade5fa6aaccf42fd", new DateTime(2025, 11, 12, 10, 0, 0, 0, DateTimeKind.Utc), "System", "sliders.show-all", new Guid("c75e1cf0-84c0-4f9e-a608-e9a9b0e7d62f"), "Default", 1L }
                });

            migrationBuilder.InsertData(
                table: "Transactions",
                columns: new[] { "Id", "Amount", "CreatedAt", "CreatedBy", "DeletedOnUtc", "IsDeleted", "MetricDetails", "MetricType", "MetricValue", "ModifiedAt", "ModifiedBy", "ServiceType", "TransactionDateTime", "TransactionStatus", "Type", "Version", "WalletId" },
                values: new object[,]
                {
                    { new Guid("a1b2c3d4-e5f6-4789-abc1-def234567890"), 100.0m, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "System", null, false, null, "", 0m, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "System", "", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Started", "Charge", 1L, new Guid("c55fb374-3d74-4aa3-b576-d144c49cd184") },
                    { new Guid("b2c3d4e5-f678-9abc-1def-234567890abc"), -5.0m, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "System", null, false, null, "Posts_Count", 5.0m, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "System", "Blog", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Started", "Usage", 1L, new Guid("c55fb374-3d74-4aa3-b576-d144c49cd184") },
                    { new Guid("c3d4e5f6-789a-bc1d-ef23-4567890abcde"), 50.0m, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "System", null, false, null, "", 0m, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "System", "", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Started", "Charge", 1L, new Guid("0acc9f75-9201-4ea5-9a16-5be1c30d6f60") },
                    { new Guid("d4e5f678-9abc-1def-2345-67890abcde12"), -2.0m, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "System", null, false, null, "SMS_Count", 10.0m, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "System", "Notification", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Started", "Usage", 1L, new Guid("ed12b679-8fd0-4a0c-ade5-fa6aaccf42fd") },
                    { new Guid("e5f6789a-bc1d-ef23-4567-890abcde1234"), 10.0m, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "System", null, false, null, "Transactions_Count", 1.0m, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "System", "OnlineStore", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Started", "Refund", 1L, new Guid("17f9e83c-b763-4e38-8902-1d0583adab05") },
                    { new Guid("f6789abc-1def-2345-6789-0abcde123456"), -1.0m, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "System", null, false, null, "", 0m, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "System", "", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Started", "Adjustment", 1L, new Guid("2a5018f6-c8db-490a-9707-221469d20bb7") }
                });
